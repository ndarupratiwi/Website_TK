...
<body style="background-color: crimson;">
    ...
    ?>
        <a href="dash_guru.php"><i class="fas fa-long-arrow-alt-left fa-3x mx-5" style="color: white;"></i></a>
        <div class="container text-white">
            <div class="row" style="margin:70px auto;">
                <div class="col-sm-10 offset-sm-1 mt-5" style="background-color: indianred;">
                    <form class="setting mx-auto" style="width: 800px;" action="update_akun.php" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 text-center mt-5">
                                <button onclick="return confirm('Apakah anda yakin ingin merubah akun???')" type="submit" class="btn btn-dark">UPDATE</button>
                            </div>
                        </div>
                    </form>
                </div>
