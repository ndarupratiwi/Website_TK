...
<head>
    ...
    <title>Settings | Siswa</title>

</head>

<body style="background-color: darkgoldenrod;" class="mt-3">
    <?php
    include 'koneksi.php';
    ...
    ?>
        <a href="dash_siswa.php"><i class="fas fa-long-arrow-alt-left fa-3x mx-5" style="color: white;"></i></a>
