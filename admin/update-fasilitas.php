...
mysqli_query($koneksi, "UPDATE tb_fasilitas SET deskripsi='$deskripsi', foto='$foto' WHERE id='$id'");
...
function upload()
{
    ...
    //gambar di upload
    move_uploaded_file($tmpName, 'fotofasilitas/' . $namaFotoBaru);
    return $namaFotoBaru;
}
...
header("location:fasilitas-tk.php?pesan=input");
